[Defines]
  ...
  DEVICE_DXE_FV_COMPONENTS       = Platform/Xiaomi/sm7150/sweet.fdf.inc

!include Platform/Qualcomm/sm7150/sm7150.dsc

[BuildOptions.common]
  GCC:*_*_AARCH64_CC_FLAGS = -DMEMMAP_XIAOMI_HACKS=1 -DXIAOMI_PIL_FIXED=1 -DENABLE_SIMPLE_INIT -DENABLE_LINUX_SIMPLE_MASS_STORAGE
...
[PcdsFixedAtBuild.common]
  ...
  gRenegadePkgTokenSpaceGuid.PcdDeviceProduct|"Redmi Note 10 Pro"
  gRenegadePkgTokenSpaceGuid.PcdDeviceCodeName|"sweet"
